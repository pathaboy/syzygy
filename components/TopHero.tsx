...
const TopHero = () => {
  return (
    <section className="relative rounded-lg pt-28 overflow-hidden bg-gradient-to-br from-gray-100 via-white to-gray-200">
      <ShineBorder borderWidth={8} shineColor={["#A07CFE", "#FE8FB5", "#FFBE7B"]} />
      ...
      <div className="relative z-10">
        ...
        <p className="text-center text-black text-2xl font-medium mt-4 max-w-2xl mx-auto">
            ...
            >
              ...
              >
                ...
                <p>
                  ...
                  thumbnails, captions, and consistent delivery, we ensure your
                  knowledge is presented clearly and professionally.
                </p>
                <p>
                  You stay in control of medical accuracy, messaging, and final
                  approval.
                </p>
                <p>
                  We align every piece of content with your specialization,
                  maintaining professional integrity and platform compliance.
                </p>
                <p>You focus on treating patients in real life.</p>
                <p>We help you communicate consistently on screen.</p>
              </div>
            </div>
          </div>
        </div>
